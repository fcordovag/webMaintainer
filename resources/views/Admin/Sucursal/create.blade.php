...
<div class="container">
    ...
    @endif
    <h3><i class="small material-icons green-text">business</i>&nbsp;Crear Sucursal</h3>
    <form class="" method="POST" action="{{ url('/sucursales') }}">
    	{{ csrf_field() }}
      <div class="row">
        ...
        <div class="input-field col s12 m6">
		    ...
		    <select name="comuna" id="comuna" value=" {{ old('comuna') }}">
    ...
    <div class="row">
  		<div class="col s12 m6 offset-m8 left-align">
